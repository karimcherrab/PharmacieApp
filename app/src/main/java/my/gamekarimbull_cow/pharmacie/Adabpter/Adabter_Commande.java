...
public class Adabter_Commande extends RecyclerView.Adapter<Adabter_Commande.MyViewHolder> {
    Context context ;
    ArrayList<Commande> list;
    FirebaseDatabase database;

    public Adabter_Commande(Context context, ArrayList<Commande> list ,FirebaseDatabase database) {
    ...
    @NonNull
    @Override
    public Adabter_Commande.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.layout_cammande, parent,false);

        return  new Adabter_Commande.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull Adabter_Commande.MyViewHolder holder, int position) {
        ...
        holder.click_product.setOnLongClickListener(
                b->{
                    if (list.get(position).getStatue().equals("en attente")){
    ...
    void cofirmeAlert(int position) {
        ...
        layoutView.findViewById(R.id.btn_yes).setOnClickListener(
                v -> {
                    ...
                    database.getReference("Commandes").child(list.get(position).getRef()).removeValue();
